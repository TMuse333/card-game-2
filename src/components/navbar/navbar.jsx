...
const navStyle = {
height: !menuOpen || leaderboardSelected || viewRules? '0' : '100px',
overflowY:'hidden',
...
onClick={handleLoginClick}> {userLoggedIn ? 'Account' : 'Log in'}</p>
{/* <img src={search}
style={{
height:'25px'
}}/> */}
...
<li className=''
onClick={handleLoginClick}>{userLoggedIn ? 'Account' : 'Log in'}</li>
