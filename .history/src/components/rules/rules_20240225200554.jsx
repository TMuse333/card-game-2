...
const Rules = () => {
  const rulesList = [
    ...
    '',
    'There are 8 cards and when you click on them, they all have a unique pokemon on the back of them. It is essential the memorize each card, because when the game starts one of the pokemon will randomly appear',
