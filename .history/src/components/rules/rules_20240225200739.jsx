...
const Rules = () => {
  const rulesList = [
    ...
    'After every turn the cards will be reshuffled so simply memorizing the positions of each pokemon will not work memeorize which card has which pokemon because they will move every turn',
