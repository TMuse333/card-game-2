...
const Rules = () => {
  const rulesList = [
    ...
    'After every turn the cards will be reshuffled and a new ra so simply memorizing the positions of each pokemon will not work memorize which card has which pokemon because they will move every turn.',
