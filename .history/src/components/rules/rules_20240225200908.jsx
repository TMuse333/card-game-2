...
const Rules = () => {
  const rulesList = [
    ...
    'Your goal is to score 1500 points, that is considered an ultra instinct type of performance, which is needed in everyday life to succeed. 1499 to 500 is a respectable effort but '
  ];
