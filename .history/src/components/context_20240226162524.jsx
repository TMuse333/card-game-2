...
export const GameProvider = ({ children }) => {
  ...
  const getRandomNumber = (currentNumber) => {
    let newRandomNumber;
    
    do {
      newRandomNumber = Math.floor(Math.random() * 8);
    } while (newRandomNumber === currentNumber);
  
    return newRandomNumber;
  };

  const handleRandomNumberChange = () => {
    setRandomNumber((prevRandomNumber) => getRandomNumber(prevRandomNumber));
  };
