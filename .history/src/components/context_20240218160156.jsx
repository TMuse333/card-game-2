...
export const GameProvider = ({ children }) => {
  const shuffleCards = () => {
    return Array.from({ length: 8 }, (_, index) => index).sort(() => Math.random() - 0.5);
  };
  ...
  useEffect(() => {
    ...
    if (gameStarted) {
      ...
      // Set up auto-shuffling every 10 seconds
  ...
  }, [timer, shuffleCards, getRandomNumber, randomNumber, randomCard,gameStarted]);
