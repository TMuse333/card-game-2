...
const style = (index) => {
    ...
    return {
      ...
      boxShadow: correctCard === true  && isSelected && gameStarted? '0 0 20px green' : incorrectCard === false && isSelected  && gameStarted === true? '0 0 12px red' : isSelected ? '0 0 10px gold' : null,
