...
const CardSet = () => {
    ...
    const {  gameStarted,setGameStarted,cardsMatch,setCardsMatch,shuffledIndexes,setShuffledIndexes,shuffleCards,gameCompleted,setTotalScore,setGameCompleted } = useGameContext();
