...
const CardSet = () => {
    ...
    const { shuffleCards, gameStarted,setGameStarted } = useGameContext();
...
const style = (index) => {
    ...
    const clickedCard = cards[0];

    console.log('the clicked card is...',clickedCard.alt)

    if(clickedCard.alt === randomCard){
        console.log('the cards math')
    }
