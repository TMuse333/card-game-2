...
import incorrectAudio from 'src/media/incorrect-selection.wav'
...
username,leaderboardSelected,
setUsername } = useGameContext();
...
const style = (index) => {
    ...
    return {
      ...
      boxShadow: correctCard === true  && isSelected && gameStarted === true? '0 0 20px green' : incorrectCard === false && isSelected  && gameStarted === true? '0 0 12px red' : isSelected ? '0 0 10px gold' : null,
    //   transform: isFlipping ? 'scale(1.1) rotateY(180deg)' :isClicked ? ' rotateY(-180deg)' : 'scale(1)',
      transition: 'transform 0.2s ease-in',
      border: correctCard && gameStarted === true? '2px solid green' : incorrectCard ? '2px solid red': null,
