...
const CardSet = () => {
    ...
    const {  gameStarted,setGameStarted,cardsMatch,setCardsMatch,shuffledIndexes,setShuffledIndexes,shuffleCards,gameCompleted,setTotalScore } = useGameContext();
...
<Clock/>
    ...
    > How to play</button>
        ...
        <button className="game-button"
       onClick={handleHomeCl} > Home screen</button> 
    )}
