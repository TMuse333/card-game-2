...
setCountDownInit,countDownInit } = useGameContext();
...
const scoreboardStyle = {
    opacity:gameCompleted ? '1' : '1',
    position:gameCompleted ? 'absolute' : 'relative',
    top:gameCompleted ? '-10%' : 'auto',
    display: gameCompleted? 'none' : 'block'
}
