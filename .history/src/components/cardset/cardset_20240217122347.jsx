...
import dexoys from '../../media/deoxys.gif'
import gengar from '../../media/gengar.gif'
import mewtwo from '../../media/mewtwo.gif'
import pikachu from '../../media/charizard.gif'
import rayquaza from '../../media/charizard.gif'
import sudowudi from '../../media/charizard.gif'
